                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td class="content">
                        ...
                        <br>
                        <a href="https://arkademy.com/upload-bukti-pembayaran?id_billing=${id_billing}" class="button button--primary button--block">
...
const emailReminderBeforeBilling = ({
  fullname
}) => {
  return `
  <!doctype html>
                  ...
                  <tr>
                    <td class="content">
                      ...
                      <div>
                        ...
                        <h3 class="text-light">
                          Mau mengingatkan nih, nanti di tanggal 25 kamu akan dapat tagihan untuk <i>“Income Sharing Agreement”</i> ke Arkademy melalui nomor Virtual Account yang akan di kirim.
                        </h3>
                      </div>
                      <br>
                      <p class="">
                        Jangan lupa bayar yaaa..
                      </p>
                    </td>
                  </tr>
                </table>
